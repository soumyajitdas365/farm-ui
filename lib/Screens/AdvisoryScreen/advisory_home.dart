...
import 'package:farm_ui/Screens/AdvisoryScreen/registered_plot.dart';
import 'package:farm_ui/Utils/Constants/colors.dart';
import 'package:farm_ui/Utils/Constants/dimensions.dart';
import 'package:flutter/material.dart';
import 'package:gap/gap.dart';

class AdvisoryHome extends StatefulWidget {
  const AdvisoryHome({super.key});

  @override
  State<AdvisoryHome> createState() => _AdvisoryHomeState();
}

class _AdvisoryHomeState extends State<AdvisoryHome> {
  @override
            ...
            FarmButton(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const RegisteredPlot(),
                    ),
                  );
                },
