...
class RegisteredPlot extends StatefulWidget {
  const RegisteredPlot({super.key});

  @override
  State<RegisteredPlot> createState() => _RegisteredPlotState();
}

class _RegisteredPlotState extends State<RegisteredPlot> {
  @override
              ...
              FarmButton(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const Advisory(),
                      ),
                    );
                  },
                  text: "Proceed")
