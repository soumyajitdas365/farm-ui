...
import 'package:farm_ui/Screens/MyFarm/my_farm_my_plots.dart';
import 'package:farm_ui/Utils/Constants/colors.dart';
import 'package:farm_ui/Utils/Constants/dimensions.dart';
import 'package:flutter/material.dart';
import 'package:gap/gap.dart';

class MyFarmRegisteredPlot extends StatefulWidget {
  const MyFarmRegisteredPlot({super.key});

  @override
  State<MyFarmRegisteredPlot> createState() => _MyFarmRegisteredPlotState();
}

class _MyFarmRegisteredPlotState extends State<MyFarmRegisteredPlot> {
  @override
              ...
              FarmButton(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const MyFarmMyPlots(),
                      ),
                    );
                  },
                  text: "Proceed")
